    ...
    components: {
      MuiButton: {
        styleOverrides: {
          ...
          containedPrimary: {
            // Ensure primary buttons use the theme correctly
      ...
      MuiTooltip: {
        styleOverrides: {
          tooltip: {
            ...
            backgroundColor:
              mode === "dark"
                ? alpha(lavenderPalette.primary.main, 0.9)
                : alpha(lavenderPalette.primary.main, 0.95),
            color: lavenderPalette.primary.contrastText,
            fontSize: "0.75rem",
            maxWidth: 300,
          },
